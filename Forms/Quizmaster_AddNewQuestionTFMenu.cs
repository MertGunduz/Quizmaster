    ...
    public partial class Quizmaster_AddNewQuestionTFMenu : Form
    {
        ...
        private void AddImageToQuestion_ButtonINS_Click(object sender, EventArgs e)
        {
            ...
            if ((question != "" && question != " ") && (questionAnswer != "" && questionAnswer != " "))
            {
                ...
                {
                    File.AppendAllText($"{Classes.Configuration.drivePath}Quizmaster\\Questions & Genres\\Questions.txt", question + ":" + questionAnswer + ":" + "IMG_NOT_INCLUDED" + Environment.NewLine);
                }
                else
                {
                    File.AppendAllText($"{Classes.Configuration.drivePath}Quizmaster\\Questions & Genres\\Questions.txt", question + ":" + questionAnswer + ":" + "IMG_INCLUDED" + ":" + imageName + Environment.NewLine);
                }
